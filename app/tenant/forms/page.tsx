            ...
            <div key={f.id} className="rounded-2xl border border-border bg-card p-4 flex items-center gap-4">
              ...
              <div className="flex items-center gap-2 shrink-0">
                <button onClick={() => viewSubmissions(f)} title="View submissions"
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-violet-50 dark:bg-violet-950/40 text-violet-600 dark:text-violet-400 hover:bg-violet-100 dark:hover:bg-violet-900/60 text-xs font-medium transition-colors">
