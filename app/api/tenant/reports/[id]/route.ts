...
export async function GET(
  ...
  try {
    ...
    const report = await db.select({
      ...
      scheduleConfig: savedReports.scheduleConfig,
...
export async function PATCH(
  ...
  try {
    ...
    if (is_scheduled !== undefined) updateData.isScheduled = is_scheduled;
    if (schedule_config !== undefined) updateData.scheduleConfig = schedule_config;
