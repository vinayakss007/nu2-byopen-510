    ...
    <div className="space-y-5 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-1 sm:pb-0 scrollbar-thin">
          {/* View toggle */}
          <div className="flex items-center border border-border rounded-lg overflow-hidden text-xs bg-card shrink-0">
          ...
          {permissions.canImport&&(
            <Button variant="outline" size="sm" className="gap-1.5 text-xs shrink-0" onClick={()=>setShowImport(true)}>
              <Upload className="w-3.5 h-3.5"/>Import
            </Button>
          )}
          {permissions.canCreate&&(
            <Button size="sm" className="gap-1.5 bg-violet-600 hover:bg-violet-700 text-white text-xs shrink-0 shadow-md" onClick={()=>setShowAdd(true)}>
