...
export const billingEvents = pgTable('billing_events', {
  ...
  return {
    tenantIdx: utils.tenantIdx(table, table.createdAt),
...
export const reportExecutions = pgTable('report_executions', {
  ...
  return {
    tenantIdx: utils.tenantIdx(table, table.executedAt),
    metadataGinIdx: utils.metadataIdx(table),
  };
});
...
export const selectiveRestoreAuditLog = pgTable('selective_restore_audit_log', {
  ...
  return {
    tenantIdx: utils.tenantIdx(table, table.performedAt),
  };
});
...
export const selectiveRestoreLogs = pgTable('selective_restore_logs', {
  ...
  return {
    tenantIdx: utils.tenantIdx(table, table.startedAt),
  };
});
