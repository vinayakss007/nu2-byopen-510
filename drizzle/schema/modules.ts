import { uniqueIndex, pgTable, uuid, text, timestamp, jsonb, index } from 'drizzle-orm/pg-core';
import { tenants, users } from './core';
import * as utils from './utils';

// ── 1. MODULE REGISTRY ────────────────────────────────
export const modules = pgTable('modules', {
  id: text('id').primaryKey(), // Using text ID like 'whatsapp-bot'
...
export const tenantModules = pgTable('tenant_modules', {
  ...
  enabledFeatures: jsonb('enabled_features').default([]), // e.g. ["ai_reply", "campaigns"]
